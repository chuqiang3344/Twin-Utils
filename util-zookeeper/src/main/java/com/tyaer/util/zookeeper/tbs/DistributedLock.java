package com.tyaer.util.zookeeper.tbs;
...
public class DistributedLock implements Watcher {
    ...
    private static final String CONNECTION_STRING = "192.168.157.100:2181";
...
//        Thread.sleep(2000);
    ...
    public boolean checkMinPath() throws KeeperException, InterruptedException {
        ...
        switch (index) {
            ...
            case 0: {
                LOG.info(LOG_PREFIX_OF_THREAD + "子节点中，我果然是老大" + selfPath);//最小
                return true;
            }
            default: {
                ...
                try {
                    zk.getData(waitPath, true, new Stat());//todo
                    return false;
    ...
    public void process(WatchedEvent watchedEvent) {
        ...
        if (Event.KeeperState.SyncConnected == keeperState) {
            ...
            } else if (Event.EventType.NodeDeleted == type && watchedEvent.getPath().equals(waitPath)) {
