...
//        System.out.println(isMessyCode2("杈撳
        ...
        System.out.println(StringHandle.praseRegexSimple("id=1584058483&type=0&refer_flag=1005055013_","id=(\\d+?)&"));
//        System.out.println(StringHandle.praseRegexSimple("id=3115110&refer_flag=1005055013_","id=(\\d+?)&"));
        String r_uid="id=3115110&refer_flag=1005055013_";
        String r_uid1 = r_uid.substring(r_uid.indexOf("id=") + 3, r_uid.indexOf("&"));
        System.out.println(r_uid1);
...
// );
    ...
    public void bj(){
        ...
        for (int i = 0; i < 1000; i++) {
            String r_uid1 = r_uid.substring(r_uid.indexOf("id=") + 3, r_uid.indexOf("&"));
//            String r_uid1 = StringHandle.praseRegexSimple(r_uid, "id=(\\d+?)&");
            System.out.println(r_uid1);
        }
    }
