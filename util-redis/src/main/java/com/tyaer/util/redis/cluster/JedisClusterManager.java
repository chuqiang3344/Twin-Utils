...
//		jedisClusterNodes.add(new HostAndPort("10.248.161.7", 7002));
    ...
    public JedisCluster getRedisCluster(String redisURLs,String passWord) {
        Set<HostAndPort> jedisClusterNodes = new HashSet<HostAndPort>();
//		String redisURLs = Config.get(Config.KEY_REDIS_URL);
//        String redisURLs = "";
        String[] redisURLArray = redisURLs.split("\\,");
...
//		jedisClusterNodes.add(new HostAndPort("10.248.161.7", 7002));
        ...
        JedisCluster jedisCluster = new JedisCluster(jedisClusterNodes, 1000,1000, 10,passWord,jedisPoolConfig);
        LOGGER.info("jedisCluster连接成功！");
