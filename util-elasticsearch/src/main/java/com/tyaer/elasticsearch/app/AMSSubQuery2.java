 ...
 */
public class AMSSubQuery2 {
    private static final Logger logger = Logger.getLogger(AMSSubQuery2.class);
...
//                    System.out.println(source);
                     ...
                     * 数据操作
                     */
                    esBulkHandler.deleteFieldChangeToBuilder(index,"t_article",id,"mid_f");
                }
...
//                logger.info(scrollId.equals(scrollId2));
    ...
    private static BoolQueryBuilder getQueryBuilder0() {
        ...
        //属性
        queryBuilder0.must(QueryBuilders.termQuery("mid_f","article_source"));
