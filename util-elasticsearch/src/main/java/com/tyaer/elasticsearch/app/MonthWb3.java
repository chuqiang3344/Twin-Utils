 ...
 */
public class MonthWb3 {
    private static final Logger logger = Logger.getLogger(MonthWb3.class);
    ...
    public static void main(String[] args) {
         ...
         * 查询设置
         */
        String[] types = new String[]{"t_status_weibo"};
//        types = new String[]{"t_article"};
        if (types != null && types.length > 0) {
            searchRequest.setTypes(types);
        }
        int pageSize = 1000;
        Scroll scoll = new Scroll(new TimeValue(600000));//翻页器
