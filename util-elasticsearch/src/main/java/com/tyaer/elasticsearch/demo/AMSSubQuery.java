package com.tyaer.elasticsearch.demo;
...
//        searchRequest.addSort("created_at", SortOrder.DESC);//排序规则
        searchRequest
                .setSearchType(SearchType.QUERY_AND_FETCH)//pageSize*shardNum=recordsNum
...
//                logger.info(scrollId.equals(scrollId2));
    ...
    private static void dataHandle(SearchResponse searchResponse) {
